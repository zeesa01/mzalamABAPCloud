"! This class is used to fill travel data into the table zrap100_atravza
CLASS zrap100_mzalam DEFINITION
 PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zrap100_mzalam IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'za',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atravza.
*    DELETE FROM zrap100_dtravza.

    "insert travel demo data
    INSERT zrap100_atravza  FROM (
        SELECT
